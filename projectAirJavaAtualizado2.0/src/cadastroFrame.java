...
public class cadastroFrame extends javax.swing.JFrame {
    ...
    private void JButton_CadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JButton_CadastrarActionPerformed
      ...
      /* if(!(CPF.length()== 11)){
           JOptionPane.showMessageDialog(rootPane, "CPF é inv[álido.");
        }
        if(!(RG.length()== 7)){
           JOptionPane.showMessageDialog(rootPane, "RG é inv[álido.");
        }
        ...
        if(SENHA.length() < 8){
             JOptionPane.showMessageDialog(rootPane, "Senha deve conter 8 no mínimo 8 caracteres.");
        }
        if(!(CONFIRMSENHA.equals(SENHA))){
             JOptionPane.showMessageDialog(rootPane, "Senhas não conferem.");
                ...
                String caminho = 
                "C:\\Users\\Yasmine.if\\Documents\\NetBeansProjects\\projectAirJava4\\projectAirJavaAtualizado2.0\\src\\bancoDadosCadastro";
                ...
                JOptionPane.showMessageDialog(rootPane, "TryCatch");
            } 
                //}
