...
public class passagensAereasFrame extends javax.swing.JFrame {
        ...
        public static String QUANTIDADEASSENTOS;
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Numero do Assento");
    ...
    private void ComprarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ComprarActionPerformed
            try {
                ...
                QUANTIDADEASSENTOS = (String) jComboBox2.getSelectedItem();
                
                String reservaPassagens = "Usuário: " + emailPassagens + "\n" +"Origem: " + ORIGEM + "\n" + "Destino: " + DESTINO
                        +"\n" + "diaIda: " + DIAIDA + "\n" + "diaVolta: " + DIAVOLTA +
                        "\n" + "mesIda: " + MESIDA + "\n" + "mesVolta" + MESVOLTA + "\n" +
                        "anoIda: " + ANOIDA + "\n" + "anoVolta: " + ANOVOLTA + "\n" +
                        "QuantidadeAssento: " + QUANTIDADEASSENTOS + "\n\n";
                
                String caminho = "C:\\Users\\rafan\\OneDrive\\Documentos\\NetBeansProjects\\projectAirJava1\\projectAirJavaAtualizado2.0\\src\\BancoDadosPassagens";
                
                File bancoDadosPassagens = new File(caminho);
                FileWriter wr = new FileWriter(bancoDadosPassagens, true);
